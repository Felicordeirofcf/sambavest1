...
const featuredCategories = [
  {
    ...
    slug: 'carnaval-2027',
    images: [
      '/products/beija-flor-2027-zeneida.webp', // Beija-Flor 2027
      '/products/viradouro27.webp',              // Viradouro 2027
    ],
  },
  {
    ...
    images: [
      '/products/beijaflor26.webp',              // Beija-Flor 2026
      '/products/viradouro25.webp',              // Viradouro 2025
    ],
  },
];
  ...
  return (
    <>
      ...
      <div className="w-full bg-[#F9F9F9]">
        ...
        {/* Banners de Categorias com Duas Imagens por Card */}
