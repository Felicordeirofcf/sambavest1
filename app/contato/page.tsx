        ...
        <div className="w-full md:w-1/3 space-y-8">
          ...
          <div className="pt-6 border-t border-gray-100">
             ...
             <div className="flex gap-4">
                <span className="text-xs uppercase tracking-widest text-gray-400 cursor-pointer hover:text-[#0B1B34]">Instagram</span>
                <span className="text-xs uppercase tracking-widest text-gray-400 cursor-pointer hover:text-[#0B1B34]">Facebook</span>
             </div>
          </div>
        </div>
        ...
        <div className="w-full md:w-2/3 bg-[#FAF7EF] p-8 md:p-12 rounded-sm">
          ...
          <form className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="flex flex-col gap-2">
              ...
              <input type="text" className="border border-gray-300 p-3 text-sm focus:outline-none focus:border-[#C9A227] bg-white" />
            </div>
            <div className="flex flex-col gap-2">
              <label className="text-xs uppercase font-semibold text-gray-500">E-mail</label>
              <input type="email" className="border border-gray-300 p-3 text-sm focus:outline-none focus:border-[#C9A227] bg-white" />
            </div>
            ...
            <div className="flex flex-col gap-2 md:col-span-2">
              ...
              <textarea rows={5} className="border border-gray-300 p-3 text-sm focus:outline-none focus:border-[#C9A227] bg-white"></textarea>
            </div>
            <button className="md:w-max px-12 py-4 bg-[#0B1B34] text-white uppercase tracking-widest text-xs font-bold hover:bg-[#C9A227] hover:text-[#0B1B34] transition-colors">
              Enviar Mensagem
            </button>
          </form>
        </div>
