        ...
        <div className="flex flex-col lg:flex-row gap-10">
          ...
          <div className="w-full lg:w-[400px] space-y-6">
            <div className="bg-white p-6 shadow-sm rounded-sm sticky top-24">
              ...
              <div className="bg-[#F0DFA8]/30 p-4 mb-6 text-[11px] text-[#0B1B34] leading-relaxed uppercase tracking-wider">
                Você será redirecionado para o WhatsApp da Samba Vest com o resumo do seu
                pedido pronto para enviar e combinar a forma de pagamento.
              </div>
